<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @endcan
            @can('backup-apps-and-db')
                <li class="{{ request()->is('backup*') ? 'active' : '' }}">
                    <a href="{{ url('/backup') }}" class="nav-link"><i
                            class="fas fa-database"></i><span>Perawatan</span></a>
                </li>
            @endcan
            ...
            @can('site-setting-edit')
                <li class="{{ request()->is('site-setting*') ? 'active' : '' }}">
                    <a href="{{ route('setting.index') }}" class="nav-link"><i class="fa fa-cog"></i><span>Pengaturan
                            Website</span></a>
                </li>
            @endcan
        </ul>
